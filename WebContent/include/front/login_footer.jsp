 ...
 *				: [20240627120000][pluto@HAPPYSTEPS.COM][CREATE: Initial Release]
 */
%>
...
<style>
  ...
  .footer-menu {
    display: inline-block; /* inline-block을 사용하여 가운데 정렬 */
    text-align: left; /* 내부 텍스트는 왼쪽 정렬 */
  }
  ul.menu-list {
    padding: 0;
    list-style: none; /* 리스트 앞의 '-' 표시 제거 */
  }
  .container {
    display: flex;
    justify-content: center; /* 수평 가운데 정렬 */
    align-items: center; /* 수직 가운데 정렬 */
    flex-direction: column; /* 내용이 수직으로 쌓이도록 설정 */
  }
  #footer-bottom {
    text-align: center; /* 하단 영역 가운데 정렬 */
  }
</style>
