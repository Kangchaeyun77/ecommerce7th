	...
	<form id="frmServices">
		<div class="container" style="max-width: 1200px; margin: 0 auto; padding: 10px;">
			<article class="txtCenter">
				...
				<h2 style="text-align: center; font-size: 30px; color: #444; margin-top: 20px;">서비스 안내</h2>

				<div style="display: flex; flex-direction: column; align-items: center; margin-top: 20px;">
					<div style="display: flex; justify-content: center; margin-bottom: 10px;">
						<div style="border: 1px solid #ccc; border-radius: 10px; padding: 20px; margin: 10px; width: 280px;">
