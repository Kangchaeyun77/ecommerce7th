...
<body>
	<form id="frmMain" method="POST">
	 <input type="hidden" id="animalId" value="<%= request.getParameter("animalId") %>" /> <!-- 서버에서 animalId 전달받음 -->
        <input type="hidden" name="animalId" id="animalId" value="<%= request.getParameter("animalId") %>" />
		<div class="container">
